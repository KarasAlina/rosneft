...
export default {
  ...
  computed: {
    ...
    totalCount() {
      ...
      return this.$store.getters['profile/listAll']?._meta.totalCount;
    },

    profiles() {
      return this.$store.getters['profile/listAll']?.items;
    },
  ...
  methods: {
    ...
    async getProfiles() { // все профили текущего промо
      ...
      await this.$store.dispatch('profile/GetProfilesAll', o);
