...
export default {
  ...
  computed: {
    ...
    totalCount() {
      ...
      return this.$store.getters['report/data']?._meta.totalCount;
    },

    exports() {
      return this.$store.getters['report/data']?.items;
    },
  ...
  methods: {
    ...
    async setReport(name) {
      ...
      await this.$store.dispatch('report/SetItem', data);
    ...
    async deleteExport(id) {
      ...
      if (confirm.value) {
        await this.$store.dispatch('report/DeleteItem', id);
    ...
    async getList() {
      ...
      await this.$store.dispatch('report/GetList', o);
