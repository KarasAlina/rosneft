...
import {
  BCard, BTable, BRow, BCol, BPagination, BDropdown, BDropdownItem, BDropdownForm, BButton, BBadge, BOverlay, BFormCheckbox,
} from 'bootstrap-vue';
...
export default {
  ...
  computed: {
    ...
    fields() {
      return this.$store.getters['manager/options'];
    },
    perPage: {
      get() {
  ...
  methods: {
    ...
    async setTableFields(field) {
      ...
      this.$store.commit('manager/SET_OPTIONS', this.fields);
